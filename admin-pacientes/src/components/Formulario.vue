    ...
    <div class="w-1/2 ml-8">
        ...
        @submit.prevent="validar">
            ...
            <div class="mb-5">
                ...
                <input @input="$emit('update:nombre',$event.target.value)" :value="props.paciente.nombre" type="text" class=" border-4 w-full p-2 mt-2 mb-5 placeholder-indigo-600 rounded-lg" placeholder="Nombre de Mascota" id="mascota"> 
                
            </div>
            <!-- NOMBRE DEL PROPIETARIO -->
            <div class="mb-5">
                <label for="propietario" class="block text-gray-700 uppercase font-bold">Nombre de Propietario</label>
                <input @input="$emit('update:propietario',$event.target.value)" type="text" class=" border-4 w-full p-2 mt-2 mb-5 placeholder-indigo-600 rounded-lg" :value="props.paciente.value.propietario"
